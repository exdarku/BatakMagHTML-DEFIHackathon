...
import { idlFactory } from './bin.did.js';
export { idlFactory } from './bin.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BIN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bin.did.js")._SERVICE>}
 */
export const bin = createActor(canisterId);
